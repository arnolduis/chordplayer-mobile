...
module.exports = function () {
    ...
    var lblMelody = ko.observable("Melody solmization");
    var lblBtnNext = ko.observable("NEXT");
    ...
    obj.actMelody = actMelody;
    obj.actMelodyNote = actMelodyNote;
    obj.actScaleBase = actScaleBase;
    obj.actScaleType = actScaleType;
    obj.actScale = actScale;
    obj.actCadenceNotes = actCadenceNotes;
    obj.totsMelody = totsMelody;
    obj.totsCadence = totsCadence;
    obj.cadenceSpeed = cadenceSpeed;
    obj.selectedInstruments = selectedInstruments;
    obj.states = states;
    obj.actState = actState;

    obj.generateMelody = generateMelody;
    obj.showMelody = showMelody;
    obj.playMelody = playMelody;
    obj.stopMelody = stopMelody;
    obj.playCadence = playCadence;
    obj.playNotes = playNotes;
    obj.step = step;
    obj.stepPlay = stepPlay;
    obj.stepShow = stepShow;
